...
public class GradeManager {
    public static void main(String[] args) {
        ...
        GradeCalculator calculator = new WeightedGradeAdapter(new AdvancedAnalyticsService());
        ...
        while (continueLoop) {
            try {
                ...
                System.out.println("Nhập " + n + " điểm số (theo thứ tự: kiểm tra miệng, giữa kỳ, cuối kỳ):");
                for (int i = 0; i < n; i++) {
                ...
                System.out.println("Trung bình có trọng số: " + average);
