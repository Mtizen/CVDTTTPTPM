...
public class Main {
    public static void main(String[] args) {
        ...
        GradeCalculatorFactory factory = new StudentGradeCalculatorFactory(); // Có thể thay bằng TeacherGradeCalculatorFactory
        GradeCalculator calculator = factory.createStudentCalculator();
